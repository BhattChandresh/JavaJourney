...
public class FindMinMaxValueFromArrayTest {
    ...
    public static int[][] input() {
        return new int[][]{{25, 14, 56, 15, 36, 56, 77, 18, 29, 49}, {3, 11, 21, 29, 41, 54, 61, 78, 110, 127}, {-2, 3, -9, 1235, 0, 6, 2, -12, -99, 33, 8888}};
    }

    @Test
    public void test_getMinAndMaxValueByBruteForceAlgo() {
        int[] result = min_max_val.getMinAndMaxValueByBruteForceAlgo(testArr);
        if (count == 1) {
